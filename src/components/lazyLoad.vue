  ...
  <div class="row">
    <div class="col-2">
      <div class="container">
        <div class="row">
          <h3>Ad Content</h3>
          <img id="images" v-for="id1 in imageIds1" :key="id1" :src="`https://picsum.photos/id/${id1}/100/100`" />
        </div>
      </div>
    </div>
    <div class="col-8">
    ...
    <div class="col-2">
      <div class="container" style="justify-content: end">
        <div class="row">
          <h3>Ad Content</h3>
          <img id="images" v-for="id2 in imageIds2" :key="id2" :src="`https://picsum.photos/id/${id2}/100/100`" />
        </div>
      </div>
    </div>
  </div>
